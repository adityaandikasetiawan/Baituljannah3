...
import { CheckCircle, FileText, Calendar, Users, Award, Download, Upload } from 'lucide-react';
...
export default function AdmissionPage() {
  ...
  const units = [
    ...
    },
    {
      ...
      quota: '90 siswa',
      color: '#8B5CF6',
      logo: '/uploads/logos/SMA.webp'
    },
    {
      code: 'slbit',
      name: 'SLBIT',
      age: 'Sesuai kebutuhan',
      quota: '30 siswa',
      color: '#14B8A6',
      logo: '/uploads/logos/SLB.webp'
    }
  ];
