      ...
      <div className="container-custom py-8">
        ...
        <div className="bg-gradient-to-br from-[#1E4AB8] to-[#8B5CF6] rounded-3xl p-8 mb-8 text-white shadow-strong">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl mb-2">Data Akademik</h1>
            ...
            <div className="flex gap-3">
              ...
              >
                ...
                <option value="Genap 2023/2024">Semester Genap 2023/2024</option>
              </select>
            ...
            {selectedTab === 'grades' && (
              <div className="space-y-6">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tfoot className="bg-gray-50 border-t-2 border-gray-300">
                      <tr>
                        <td colSpan={7} className="px-4 py-3 font-medium">Rata-rata</td>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6">
                  <h3 className="text-lg mb-4">Grafik Performa</h3>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className={`px-2 py-0.5 text-xs rounded-full ${
                            ...
                            {assignment.status === 'graded' ? 'Dinilai' :
                             assignment.status === 'submitted' ? 'Terkirim' :
                             'Belum Dikerjakan'}
                          </span>
                        </div>
                        ...
                        <div className="text-sm text-gray-600 flex items-center gap-4">
                          ...
                          {assignment.submittedDate && (
                            <span>
                              Dikumpulkan: {new Date(assignment.submittedDate).toLocaleDateString('id-ID')}
                            </span>
                          )}
                        </div>
                      </div>
