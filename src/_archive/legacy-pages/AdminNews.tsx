...
export const AdminNews: React.FC<AdminNewsProps> = ({ onNavigate = () => {} }) => {
  ...
  const menuItems = [
    ...
    { label: 'Rekrutmen', href: '#', onClick: () => onNavigate('admin-career') }
  ];
      ...
      <div className="container-custom py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl mb-2">Manajemen Berita</h1>
              <p className="text-gray-600">Kelola semua berita dan pengumuman sekolah</p>
            </div>
            <button
            ...
            <div className="p-6 border-t border-gray-200 flex gap-3">
              ...
              {modalMode !== 'view' && (
                ...
                >
                  ...
                  <span>{modalMode === 'create' ? 'Tambah Berita' : 'Simpan Perubahan'}</span>
                </button>
              )}
            </div>
          </div>
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl">
            ...
            <h3 className="text-xl text-center mb-2">Hapus Berita?</h3>
            <p className="text-gray-600 text-center mb-6">
              Berita yang dihapus tidak dapat dikembalikan. Apakah Anda yakin?
            </p>
